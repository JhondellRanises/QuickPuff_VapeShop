        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-footer">
                    ...
                    <button class="btn btn-warning btn-sm w-100 mt-2" onclick="debugSaleData()">
...
// Debug function to test data sending
function debugSaleData() {
    if (cart.length === 0) {
    ...
    console.log('Debug - Sending cart data:', requestData);
    
    // Send to debug endpoint
    fetch('<?= site_url('/test-sale') ?>', {
        method: 'POST',
        headers: {
...
function printReceipt() {
    ...
    printWindow.document.write(`
        ...
        <head>
            ...
            <style>
                @page {
                    size: auto;   /* Auto size to fit content */
                ...
                body {
                    ...
                    max-width: 300px;    /* Maximum width for receipt paper */
                }
                .receipt-container {
                    width: 100%;
                    padding: 5px;
                ...
                @media print {
                    @page {
                        size: auto;   /* Auto size to fit content */
                        margin: 3mm;  /* Very small margins for printing */
                    }
                    body {
                        width: fit-content;
                        min-width: 280px;
